...
namespace Thry.TPS
{
    ...
    public class Orifice : TPSComponent
    {
        ...
        public ShapekeyConfig[] OpeningShapekeys = 
        {
            new ShapekeyConfig(){shapekeyName = "none", depth = 0.5f},
            new ShapekeyConfig(){shapekeyName = "none", depth = 1}
        };
